...
const Sidebar = () => {
  ...
  const {users , getUsers, isUsersLoading , selectedUser ,  setSelectedUser , onlineUsers} = useChatStore();
  ...
  return (
    <div className={`flex-col w-full md:flex  h-full md:w-100 lg:w-130 border-r ${selectedUser?"hidden":"flex"}  `}>
      {/* Search Bar  */}
